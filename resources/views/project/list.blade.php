...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <a href="/project-list/create"><button class="main-buttons new">New Project</button></a>
            <table style="text-align:center;" id="project-table" class="table table-responsive-lg table-bordered">
                ...
                @else
                    ...
                    <tbody>
                        <tr>
                            <td class="text-muted" colspan="8" style="letter-spacing: 1px;font-size: 20px;"><strong>Project list is empty</strong></td>
                        </tr>
                    </tbody>
